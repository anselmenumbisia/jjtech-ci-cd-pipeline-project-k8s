...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <snapshotRepository>
            <id>nexus</id>
            <url>http://172.31.89.238:8081/repository/maven-snapshots/</url>          <!--Replace the Nexus Private IP in this line-->
        </snapshotRepository>
        <repository>
            <id>nexus</id>
            <url>http://172.31.89.238:8081/repository/maven-releases/</url>           <!--Replace the Nexus Private IP in this line-->
        </repository>
    </distributionManagement>
